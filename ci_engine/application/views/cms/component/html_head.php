...
<html>
    <head>
        ...
        <title><?php echo isset($meta_title)?$meta_title:'BFC Competition - CMS'; ?></title>
        ...
        <!-- theme custom -->
        <link href="<?php echo site_url(config_item('theme').'admin/bfc_competition.css'); ?>" rel="stylesheet">
        ...
        <!-- Nano gallery -->
        <link type="text/css" href="<?php echo site_url(config_item('library').'nanogallery/css/nanogallery.min.css'); ?>" rel="stylesheet" />
        <link type="text/css" href="<?php echo site_url(config_item('library').'nanogallery/css/themes/clean/nanogallery_clean.min.css'); ?>" rel="stylesheet" />
        
        <link type="text/css" href="<?php echo site_url(config_item('library').'bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css'); ?>" rel="stylesheet" />
