            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo date('d-M-Y H:i', $item->upload_time); ?></td>
...
<script type="text/javascript">
    $(document).ready(function (){
        $('#userfile').on('change', function(){
            if ($(this).val()){
                check_upload_format_name($(this).val());
            }
        });
    });
    
    function check_upload_format_name(filename){
        $.getJSON('<?php echo site_url('upload/check_format'); ?>',{filename:filename}, function (data){
            if (data.success=='0'){
                alert(data.message);
            }  
        });
